...
namespace DrinkAndGo.Mocks
{
    ...
    {
        private readonly ICatagoryRepository _catagoryRepository = new MockCatagoryRepository();
            ...
            get {
                return new List<Drink>
                {
                    new Drink {
                        ...
                        Category = _catagoryRepository.Categories.First(),
                        ImageUrl = "https://imggmi.com/full/2019/4/20/3f9a1e1311bd7695766965407152a37a-full.jpg.html",
                        InStock = true,
                        IsPreferredDrink = true,
                        ImageThumbnailUrl = "https://imggmi.com/full/2019/4/20/3f9a1e1311bd7695766965407152a37a-full.jpg.html"
                    },
                    new Drink {
                        Name = "Rum & Coke",
                    ...
                    new Drink
                    {
                        ...
                        Category = _catagoryRepository.Categories.Last(),
